import svgPaths from "./svg-abnn8si3bi";
  ...
  return (
    <div className="absolute bg-[#e0e0e0] bottom-[356px] content-stretch flex flex-col gap-[30px] items-start pb-[30px] pt-[20px] px-[20px] right-[106px] rounded-[5px] w-[840px]" data-name="Ex post">
      ...
      <p className="font-['Gaussian_Blur:Regular','Noto_Sans:Regular',sans-serif] leading-[normal] relative shrink-0 text-[20px] text-black" style={{ fontVariationSettings: "\'CTGR\' 0, \'wdth\' 100, \'wght\' 400" }}>
        i saw baby! the other day isn’t she so cute
      </p>
...
function ContentContainer() {
  return (
    <div className="absolute bottom-[7px] h-[887px] overflow-x-clip overflow-y-auto right-[-15px] w-[1512px]" data-name="content container">
      <ExPost />
...
export default function Baby() {
  return (
    <div className="bg-[#2b9eb3] relative size-full" data-name="Baby">
      <ContentContainer />
      <div className="absolute bottom-0 h-[982px] left-0 pointer-events-none top-0">
        <Frame />
      </div>
      <div className="absolute bottom-[43px] left-[55px] size-[91px]">
      ...
      <div className="absolute left-[66px] overflow-clip size-[69px] top-[859px]" data-name="Plus">
      ...
      <div className="absolute left-[-8px] size-[302px] top-[70px]" data-name="baby2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBaby2} />
      </div>
    </div>
  );
}