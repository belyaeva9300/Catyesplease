import svgPaths from "./svg-fhc12zw4jh";
...
function ExPost() {
  return (
    <div className="absolute bg-[#e0e0e0] bottom-[360px] content-stretch flex flex-col gap-[30px] h-[439px] items-start pb-[30px] pt-[20px] px-[20px] right-[106px] rounded-[5px] w-[840px]" data-name="Ex post">
      ...
      <p className="font-['Gaussian_Blur:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black w-[430px] whitespace-pre-wrap">{`i saw burger and ham together!  the other day arent they so cute`}</p>
...
export default function Burgerham() {
  return (
    <div className="bg-[#2bb31a] relative size-full" data-name="burgerham">
      <ContentContainer />
      ...
      <div className="absolute h-[348px] left-[157px] top-[41px] w-[175px]" data-name="image 4">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[143.08%] left-[-76.72%] max-w-none top-[-13.46%] w-[212.98%]" src={imgImage4} />
        </div>
      </div>
      ...
      <div className="absolute h-[281px] left-[18px] top-[126px] w-[173px]" data-name="image 5">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[229.63%] left-[-76.5%] max-w-none top-[-66.67%] w-[279%]" src={imgImage5} />
        </div>
      </div>
    </div>
  );
