import svgPaths from "./svg-g3v9bzvgq9";
...
function ExPost() {
  return (
    <div className="absolute bg-[#e0e0e0] bottom-[385px] content-stretch flex flex-col gap-[30px] h-[439px] items-start pb-[30px] pt-[20px] px-[20px] right-[106px] rounded-[5px] w-[840px]" data-name="Ex post">
      ...
      <p className="font-['Gaussian_Blur:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black w-[430px] whitespace-pre-wrap">i saw this weird cat the other day...who is that?</p>
...
function ContentContainer() {
  return (
    <div className="absolute h-[882px] left-0 overflow-clip top-[100px] w-[1512px]" data-name="content container">
      <ExPost />
      <div className="absolute bg-[#e0e0e0] bottom-[39px] h-[265px] right-[104px] rounded-[5px] w-[840px]" />
      <div className="absolute bg-[#e0e0e0] bottom-[-967px] h-[445px] right-[106px] rounded-[5px] w-[840px]" />
      <div className="absolute bg-[#e0e0e0] bottom-[-464px] h-[445px] right-[106px] rounded-[5px] w-[840px]" />
    </div>
  );
}
...
export default function Other() {
  return (
    <div className="bg-[#70566d] relative size-full" data-name="other">
      ...
      <div className="absolute flex h-[339px] items-center justify-center left-0 top-[56px] w-[296px]">
